...
const uint8_t SOF2 = 0xC2;
const uint8_t SOF0BAS = 0x00;
const uint8_t SOF0PRE = 0x08;
const uint8_t SOF2MINPRE = 0x08;
const uint8_t SOF2MAXPRE = 0x0C;
const uint8_t SOFMAXCOMP = 0x04;
const uint8_t SOFMINSAMP = 0x01;
const uint8_t SOFMAXSAMP = 0x04;
const uint8_t DHT = 0xC4;
const uint8_t DHTMHT = 0x01;
const uint8_t DHTBITS = 0x10;
const uint8_t SOS = 0xDA;
const uint8_t SOSSUCCBITMAX = 0x0D;
const uint8_t EOS = 0x3F;
