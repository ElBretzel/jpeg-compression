...
extern const uint8_t SOF2;
extern const uint8_t SOF0BAS;
extern const uint8_t SOF0PRE;
extern const uint8_t SOF2MINPRE;
extern const uint8_t SOF2MAXPRE;
extern const uint8_t SOFMAXCOMP;
extern const uint8_t SOFMINSAMP;
extern const uint8_t SOFMAXSAMP;
extern const uint8_t DHT;
extern const uint8_t DHTMHT;
extern const uint8_t DHTBITS;
extern const uint8_t SOS;
extern const uint8_t EOS;
extern const uint8_t SOSSUCCBITMAX;
